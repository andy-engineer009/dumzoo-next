...
const InfluencerCard = ({data}: any) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full aspect-square bg-gray-100 h-[200px]">
      ...
      <div className="p-4 space-y-3">
        {/* Name, Verification Badge, and Followers Row */}
        ...
        {/* Social Media Icons and Category Row */}
        <div className="flex justify-between items-center mb-0">
          ...
          {/* Category Tag */}
          {data?.tags?.length > 0 && (
            <div className="bg-green-400 text-white text-xs font-medium px-3 py-1 rounded-full">
              {data.tags[0]}
            </div>
          )}
        </div>

        {/* Advertising Price Section */}
        <div className="flex justify-between items-center pt-2">
          <div className="text-sm text-gray-500">Advertising Price</div>
