  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-2  flex-1 flex flex-col">
        {/* Name and Location */}
        <div className="mb-0">
          <h3 className="font-bold text-gray-900 text-md truncate flex">{data?.username || 'N/A'} 
        ...
        {/* respon time */}
                  {/* Stats Row */}
                  {/* Gender and Platforms Row */}
                  <div className=" justify-between items-center text-sm mb-0">
                    {/* Gender */}
                    <div className=" items-center text-gray-600 mt-1">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                      ...
                      {/* Platform Icons */}
                      <div className="hide gap-2 mt-1" style={{display: 'none'}}>
              {/* Title: "Available on" with same color as icons */}
              ...
              {data?.instagram_url != '' && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block text-gray-500 hover:text-pink-600 transition-colors bg-[#fff] p-1 rounded-full"
                  onClick={(e) => e.stopPropagation()}
                >
                  <svg className="w-4 h-4" fill="#000" viewBox="0 0 24 24">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                  ...
                  onClick={(e) => e.stopPropagation()}
                    ...
                    {/* <div className="flex items-center space-x-3">
                      ...
                      <div className="text-blue-600 font-[700] text-[14px]">
                        {formatCurrency(data?.starting_price || 0)} <span className="text-gray-500 font-normal"></span>
                      </div>
                    </div> */}
                  </div>
